...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, KC_ALGR, BASE,    KC_SPC,  KC_SPC,  RAISE,   KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  KC_LSFT, _______, _______, _______, _______, _______, KC_NLCK, KC_P0,   KC_PDOT, KC_PENT, KC_PPLS, KC_ENT,
  KC_LCTL, KC_LGUI, KC_LALT, KC_ALGR, LOWER,   KC_SPC,  KC_SPC,  BASE,    KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
